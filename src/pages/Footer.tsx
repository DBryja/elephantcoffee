...
export default function Footer() {
  return (
    <footer className="h-screen w-screen bg-cBlack text-cBeige flex flex-col justify-end items-center relative lg:absolute bottom-0 z-20">
      <h2 className="text-3xl md:text-4xl lg:text-5xl text-cBeige pb-20">Contact us:</h2>
