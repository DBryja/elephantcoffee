...
export default function Hero() {
  return (
    <section className="hero min-h-[627px] lg:min-h-[800px] xl:h-screen bg-cOrange-100 w-full overflow-hidden relative p-5 lg:px-8 2xl:px-16">
      ...
      <div className="mt-24 relative flex gap-y-6 flex-col lg:mt-56">
        <Heading>
          COFFEE THAT
          <br /> YOU REMEMBER
        </Heading>
