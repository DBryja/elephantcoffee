...
export default function Hero() {
  return (
    <section className="hero min-h-[627px] lg:min-h-[800px] xl:h-screen bg-cOrange-100 w-full overflow-hidden relative lg:fixed z-0 p-5 lg:px-8 2xl:px-16">
      <div className="hero_image absolute -bottom-12 -left-12 rotate-12 z-0 min-w-[120%] md:min-w-0 md:max-w-[70%] md:left-auto md:-right-24 md:-bottom-24 lg:max-w-[65%] xl:max-w-[70%] xl:-right-36 xl:-bottom-36 2xl:scale-125 2xl:right-0 k2:scale-150 k4:scale-[2] k4:right-20 k4:bottom-20">
        <picture>
