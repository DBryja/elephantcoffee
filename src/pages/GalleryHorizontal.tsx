export default function GalleryHorizontal() {
  return (
    <section className="galleryHorizontal __sectionLock h-[200vh] mt-16 overflow-hidden flex justify-center items-center relative">
      <div className="__content relative w-full max-w-[1400px] h-screen">
        <div className="__galleryAnim relative h-full -top-1/2 scale-[2.3]">
          <img
